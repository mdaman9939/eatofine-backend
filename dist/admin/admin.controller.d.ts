...
export declare class AdminController {
    ...
    orderReport(days?: string, from?: string, to?: string, zoneId?: string, restaurantId?: string, campaign?: string, orderType?: string, orderStatus?: string): Promise<{
        total: number;
        rows: {
            order_id: number;
            order_type: string;
    ...
    adminExpenseOrders(days?: string, from?: string, to?: string, zoneId?: string, restaurantId?: string, orderType?: string): Promise<{
        total: number;
        rows: {
            order_id: number;
            customer_name: string | null;
    ...
    transactionReport(days?: string, from?: string, to?: string, zoneId?: string, restaurantId?: string, orderType?: string, category?: string, orderStatus?: string): Promise<{
        total: number;
        rows: {
            order_id: number;
            order_type: string;
    ...
    gstReport(days?: string, from?: string, to?: string, zoneId?: string, restaurantId?: string): Promise<{
        total: number;
